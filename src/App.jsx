...
const workKeywordConfig = {
  "奇人密碼": {
    followUp: ["� 看看我製作的《風之國度》", "🎮 了解《精靈樂章》遊戲", "🎮 探索《慾望王座》"]
  },
  "釋悟因": {
    followUp: ["🎮 看看我製作的《風之國度》", "🎮 了解《精靈樂章》遊戲", "🎮 探索《慾望王座》"]
  },
  "風之國度": {
    followUp: ["🎮 了解《精靈樂章》遊戲", "🎮 探索《慾望王座》", "🎬 看看《奇人密碼》與《釋悟因》"]
  },
  "慾望王座": {
    followUp: ["🎮 了解《精靈樂章》遊戲", "🎮 看看《風之國度》", "🎬 看看《奇人密碼》與《釋悟因》"]
  },
  "精靈樂章": {
    followUp: ["🎮 看看《風之國度》", "🎮 探索《慾望王座》", "🎬 看看《奇人密碼》與《釋悟因》"]
  },
  "傳奇網路": {
    followUp: ["🎮 看看《風之國度》", "🎮 了解《精靈樂章》遊戲", "🎮 探索《慾望王座》"]
  },
  "合邑映像": {
    followUp: ["🎬 看看《奇人密碼》", "🎬 看看《釋悟因》紀錄片", "🎮 看看我現在的作品"]
  },
  "賽席爾商泛力": {
    followUp: ["🎬 看看後來的作品《奇人密碼》", "🎬 看看《釋悟因》紀錄片", "🎮 傳奇網路作品合集"]
  }
};
