...
const workKeywordConfig = {
  "奇人密碼": {
    followUp: ["🎮 看看我製作的《風之國度》", "🎮 了解《精靈樂章》遊戲", "📅 回到我的工作經歷"]
  },
  "釋悟因": {
    followUp: ["🎮 看看我製作的《風之國度》", "🎮 了解《精靈樂章》遊戲", "� 回到關於我"]
  },
  "風之國度": {
    followUp: ["🎮 了解《精靈樂章》遊戲", "� 看看《奇人密碼》與《釋悟因》", "✉️ 聯繫我"]
  },
  "慾望王座": {
    followUp: ["🎮 了解《精靈樂章》遊戲", "🎮 看看《風之國度》", "📅 回到工作經歷"]
  },
  "精靈樂章": {
    followUp: ["🎮 看看《風之國度》", "� 看看《奇人密碼》與《釋悟因》", "✉️ 聯繫我"]
  },
  "傳奇網路": {
    followUp: ["🎮 看看《風之國度》", "🎮 了解《精靈樂章》遊戲", "📅 回到工作經歷"]
  },
  "合邑映像": {
    followUp: ["🎬 看看《奇人密碼》", "🎬 看看《釋悟因》紀錄片", "📅 回到工作經歷"]
  },
  "賽席爾商泛力": {
    followUp: ["🎬 看看後來的作品《奇人密碼》", "� 傳奇網路作品合集", "✉️ 聯繫我"]
  }
};
